    ...
    <!-- ################# Header Starts Here#######################--->
      ...
      <header id="menu-jk">
        ...
        <div id="nav-head" class="header-nav">
            <div class="container">
                <div class="row">
                    <div class="col-lg-2 col-md-3  col-sm-12" style="color:#000;font-weight:bold; font-size:42px; margin-top: 1% !important;">S G H
                    ...
                    <div class="col-sm-2 d-none d-lg-block appoint">
                        <a class="btn btn-success" href="hms/user-login.php">Prenez rendez-vous</a>
                    </div>
                </div>
        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item ">
                    <img class="d-block w-100" src="assets/images/slider/slider_1.webp" alt="Second slide">
                    <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Système de gestion Hospitalière</h5>
                ...
                <div class="carousel-item active">
                    <img class="d-block w-100" src="assets/images/slider/slider_2.webp" alt="Third slide">
                      <div class="carousel-cover"></div>
                    <div class="carousel-caption vdg-cur d-none d-md-block">
                        <h5 class="animated bounceInDown">Système de gestion Hospitalière</h5>
                        ...
                        <div class="blog-single">
                            ...
                            <div class="blog-single-det">
                                ...
                                <a href="hms/user-login.php" target="_blank">
                                    <button class="btn btn-success btn-sm">Cliquez ici</button>
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-key">
                        ...
                        <h5>Traitements de haute qualité</h5>
...
?>
    ...
    <p><?php  echo $row['PageDescription'];?>.</p><?php } ?>
        ...
        <div class="gallery-filter d-none d-sm-block">
            ...
            <button class="btn btn-default filter-button" data-filter="hdpe">Dentisterie </button>
            ...
            <button class="btn btn-default filter-button" data-filter="irrigation">Laboratoire</button>
        </div>
        <br/>
            ...
            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter spray">
                <img src="assets/images/gallery/gallery_05.webp" class="img-responsive">
            </div>

          

            <div class="gallery_product col-lg-4 col-md-4 col-sm-4 col-xs-6 filter spray">
                <img src="assets/images/gallery/gallery_06.jpeg" class="img-responsive">
            </div>
    ...
    <section id="contact_us" class="contact-us-single">
        <div class="row no-margin">
            ...
            <div  class="col-sm-12 cop-ck">
                ...
                <h2 >Contact </h2>
                    <div class="row cf-ro">
                        <div  class="col-sm-3"><label>Nom et Prénom:</label></div>
                    ...
                    <div  class="row cf-ro">
                     ...
                     <div  class="row cf-ro">
                        <div  class="col-sm-3"><label>Télephone:</label></div>
                     ...
                     <div  class="row cf-ro">
                        ...
                        <div class="col-sm-8">
                         <button class="btn btn-success btn-sm" type="submit" name="submit">Envoyer</button>
                        </div>
                </div>
            </form>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <ul class="list-unstyled link-list">
                        <li><a ui-sref="about" href="#about">À propos</a><i class="fa fa-angle-right"></i></li>
                        ...
                        <li><a ui-sref="gallery" href="#gallery">Gallerie</a><i class="fa fa-angle-right"></i></li>
...
?>
                        ...
                        Télephone: <?php  echo $row['MobileNumber'];?> <br>
                        Email: <a href="mailto:<?php  echo $row['Email'];?>" class=""><?php  echo $row['Email'];?></a><br>
                        Temps: <?php  echo $row['OpenningTime'];?>
                    </address>
